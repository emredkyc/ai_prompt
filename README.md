<div align="center">
  <br />
    <a href="https://promptify-dev.vercel.app/" target="_blank">
      <img src="https://i.ibb.co/KyWtXWD/nextjs-banner.png" alt="Project Banner">
    </a>
  <br />
...
```bash
git clone https://github.com/emredkyc/ai_prompt.git
cd ai_prompt
```
...
Replace the placeholder values with your actual credentials. You can obtain these credentials by signing up on these corresponding websites from [Google Cloud Console](https://console.cloud.google.com/welcome/new?project=promptify-410015), [Cryptpool](https://www.cryptool.org/en/cto/openssl) (for random Auth Secret), and [MongoDB](https://www.mongodb.com/). 
...
Assets used in the project can be found [here](https://drive.google.com/file/d/1ulYAmIyyNfahMe0FgsU2I7kSENKPQ9B3/view?usp=sharing)
